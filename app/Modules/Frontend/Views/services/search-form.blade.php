...
<div class="search-form-wrapper">
    ...
    <ul class="nav nav-tabs" id="searchFormTab" role="tablist">
        @if(in_array(GMZ_SERVICE_TOUR, $srvc))
            <li class="nav-item">
                <a class="nav-link active" id="tour-search-tab" data-toggle="tab" href="#tour-search" role="tab" aria-controls="tour-search" aria-selected="false"><i class="fal fa-map-marked"></i> {{__('Tour Packages')}}</a>
            </li>
        @endif
        ...
        @endphp
            <li class="nav-item">
                <a class="nav-link {{ $hotel_active }}" id="hotel-search-tab" data-toggle="tab" href="#hotel-search" role="tab" aria-controls="hotel-search" aria-selected="true"><i class="fal fa-hotel"></i> {{__('Hotels & Rooms')}}</a>
            </li>
        @endif
    ...
    <div class="tab-content" id="searchFormTab">
        ...
        @endphp
            <div class="tab-pane fade show {{$hotel_active}} hotel-search-form" id="hotel-search" role="tabpanel" aria-labelledby="hotel-search-tab">
