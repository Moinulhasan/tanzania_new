...
<section class="bg-white mx-3 mb-5">
                        ...
                        <div class="col-md-12 d-flex row pt-4">
                            <div class="col-md-11">
                                ...
                                <p>
                                    ...
                                    @endphp
                                    <i>
                                        Posted under <a class="color-pri" href="{{route('discuss.answer',$cat->id)}}">{{$cat_name}}</a> by {{$usr_name}} {{$usr_name1}} - {{ \Carbon\Carbon::parse($ques->created_at)->isoFormat('MMM Do YYYY')}}
                                    </i>
                                </p>
                                <p class="discus">
                                    {{$ques->question}}
    ...
    <div class="pagination-wrapper">{{$quests->withQueryString()->links()}}</div>
