...
<div class="mt-3 statbox widget box box-shadow">
    ...
    <div class="row col-md-12">
        <div class="ml-auto">
            <a class="btn btn-success" href="{{route('event.create')}}">Create New</a>
        </div>
    </div>
                ...
                @endphp
                    <tr>
                        <td class="px-0 py-1"  style="display: table-cell;">
                            <div class="d-flex">
                                <div class="mx-auto">
                                    <img src="{{asset('events/'.$cat->photo)}}" width="90px" height="50px" alt="">
                                </div>
                            </div>
                        </td>
                        ...
                        <td style="display: table-cell;">
                            <div class="d-flex">
                                <div class="mx-2">
                                    <a href="{{route('event.edit',$cat->id)}}" class="text-info">
                                        Edit
                                    </a>
                                </div>
                                <div class="mx-2">
                                    <a href="{{route('event.destroy',$cat->id)}}" class="text-danger">
                                        Delete
                                    </a>
                                </div>
                            </div>
