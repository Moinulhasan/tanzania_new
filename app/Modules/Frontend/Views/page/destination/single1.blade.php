...
@section('content')
    ...
    @php
    // dd($dest);
    the_breadcrumb([], 'destination-abc', ['type' => $dest->slug, 'title' => $sidebar->title]);

        // the_breadcrumb($dest, 'destination-abc');
    @endphp
...
{{-- <div class="col-md-12 col-lg-12 d-flex container h-100 row"> --}}
        ...
        {{-- <div class="sidebar-heading border-bottom bg-light">Start Bootstrap</div> --}}
          {{--  <div class="list-group list-group-flush">
             ...
             <a class="lf_click list-group-item list-group-item-action list-group-item-grey p-3" href="{{url('destination', $dest->slug)}}" id="overview">{{$dest->title}}</a>


                 @foreach($sidebars as $item)
                     <a class="lf_click list-group-item list-group-item-action list-group-item-grey p-3 {{($item->slug) == $sidebar->slug ? 'active' : ''}}" href="{{route('destination.showByid', [$dest->slug, $item->slug])}}" id="overview"><i class="far fa-chevron-right mr-2"></i>{{$item->title}}</a>
                 @endforeach
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 pb-5">
                                ...
                                @if(!empty($sidebar))
                                    <section  class="description destClass wildlife mt-4">
