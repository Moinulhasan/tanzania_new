...
<div class="mt-3 statbox widget box box-shadow">
    ...
    <form action="{{route('destination.store')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mt-3">
            ...
            {{-- <textarea name="overview" class="form-control quil-editor">{{old('overview')}}</textarea> --}}
            <textarea class="tinymce-overview-content gmz-hidden-field" name="overview">{{old('overview')}}</textarea>
            <textarea class="myeditorinstance2" >{{old('overview')}}</textarea>
        </div>
