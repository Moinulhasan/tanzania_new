    ...
    <div class="site-navigation">
        ...
        {{-- <ul id="menu-primary-1" class="main-menu">
            ...
            <li class="menu-item menu-item-1 ">
                <a href="http://127.0.0.1:8000/tour-search">Bhutan Tour Packages</a>
            </li>
            ...
            <li class="menu-item menu-item-6 ">
                <a href="http://127.0.0.1:8000/contact-us">Contact</a>
            </li>
            ...
            <li class="menu-item-has-children">
                ...
                <ul role="menu" class="sub-menu">
                    <li>
                    <a class="" href="?currency=INR">
                                ₹ Indian Rupee
                            </a>
                        </li>
                    </ul>
                <span class="arrow">+</span><span class="arrow-pc"><i class="far fa-chevron-down"></i></span></li>
        </ul> --}}
        @php
            if (has_nav_primary()) {
                get_nav([
    ...
    <div class="user-navigation">
        <ul>
            ...
            @if(!$is_logged)
                ...
                <li><a href="#gmz-login-popup" class="btn btn-sm btn-dark gmz-box-popup" data-effect="mfp-zoom-in"><i class="fal fa-sign-in pr-2"></i>{{__('Login/Signup')}}</a></li>
            @else
