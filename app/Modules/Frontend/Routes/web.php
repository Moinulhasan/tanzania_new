...
Route::group([
    ...
    Route::get('accommodation', 'HotelController@hotelPageView')->name('hotel');
    Route::get('accommodation-search', 'HotelController@hotelSearchView')->name('hotel-search');
    Route::post('accommodation-search', 'HotelController@hotelSearchAction');
    Route::get('accommodation/{slug}', 'HotelController@singleView')->name('hotel-single');
    Route::post('accommodation-send-enquiry', 'HotelController@sendEnquiryAction');
    ...
    Route::post('accommodation-add-cart', 'HotelController@addCartAction');
});
