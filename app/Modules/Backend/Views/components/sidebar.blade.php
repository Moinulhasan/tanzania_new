    ...
    <nav id="sidebar">
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            {{-- <li class="menu @if(in_array($currentScreen, $item['screen'])) active @endif">
                ...
                <ul class="collapse submenu list-unstyled" id="{{$item['id']}}" data-parent="#accordionExample">
                    <li class="@if($child['type'] == 'hidden') d-none @endif">
                        <a href="{{route('discuss.list')}}"> Categories </a>
                    </li>
                    <li class="@if($child['type'] == 'hidden') d-none @endif">
                        <a href="{{route('discuss-category')}}">Create Category </a>
                    </li>
                </ul>
            </li> --}}
            ...
            @if (auth()->user()->id == 1)
                <li class="menu">
                    <a href="{{route('discuss.list')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="d-flex align-items-center">
                            <i class="fal fa-comment"></i>
                ...
                <li class="menu">
                    <a href="{{route('destination.list')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="d-flex align-items-center">
                ...
                <li class="menu">
                    <a href="{{route('travelguide.list')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="d-flex align-items-center">
                ...
                <li class="menu">
                    <a href="{{route('event.list')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="d-flex align-items-center">
                ...
                <li class="menu">
                    <a href="{{route('attraction.list')}}" aria-expanded="false" class="dropdown-toggle">
                        <div class="d-flex align-items-center">
