...
class ScriptController
{
    ...
    private function _enqueueScripts()
    {
        ...
        $this->_addScript('gmz-tiny-mce', asset('admin/plugins/editors/tinymce/tinymce.min.js'));
        $this->_addScript('gmz-tiny-mce-config', asset('admin/plugins/editors/tinymce/tinymceconfig.js'));
        ...
        $this->_addScript('gmz-option', asset('js/option.js?v=99.99.2'), true);
