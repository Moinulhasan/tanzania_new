...

{
...

    {
        ...
        // if (isset($post_data['prefer_month'])) {

        //     $month = get_terms('name', 'prefer_month', 'id');

        //     if (!empty($month)) {

        //         $include_in_str = '(' . implode(',', $month) . ')';
        ...
        //     $prefer_months = $post_data['prefer_month'];



        //     if (!empty($prefer_months) && is_array($prefer_months)) {

        //         foreach ($prefer_months as $item) {
        ...
        //         $post_data['prefer_month'] = implode(',', $prefer_months);

        //     } else {

        //         $post_data['prefer_month'] = '';
...

    {
        ...
        if (!empty($post_id)) {
            ...
            if (isset($post_data['prefer_month'])) {
                ...
                $post_data['prefer_month'] = implode(',', $post_data['prefer_month']);
