...
if(!function_exists('get_my_currency')) {
	function get_my_currency() {
		$currencies       = list_currencies();
		$current_currency = current_currency();
		$current_params   = '';
		$params           = $_GET; // Get Current Params
        ...
        <li class="menu-item-has-children">
			<?php foreach ( $currencies as $currency ): ?>
				<?php if ( $current_currency['unit'] == $currency['unit'] ): ?>
					<a href="#">
						<?php echo esc_html( get_translate( $currency['symbol'] ) ); ?>
						<?php echo esc_html( get_translate( $currency['name'] ) ); ?>
					</a>
					<?php break; ?>
				<?php endif; ?>
					...
					<ul role="menu" class="sub-menu">
						<?php foreach ( $currencies as $currency ): ?>
							...
							<li class="menu-item menu-item-12 ">
								<a class="" href="?currency=<?php echo $currency['unit'] . $current_params ?>">
									<?php echo esc_html( get_translate( $currency['symbol'] ) ); ?>
									<?php echo esc_html( get_translate( $currency['name'] ) ); ?>
								</a>
							</li>
