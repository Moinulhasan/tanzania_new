...
<section class="bg-white mx-3 mb-5">
    <div class="col-md-12 row pt-4">
        ...
        <div class="col-md-9">
            ...
            <?php $__currentLoopData = $disc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ques): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-md-12 d-flex row pt-4">
                            <div class="col-md-11">
                                ...
                                <p>
                                    ...
                                    ?>
                                    <i>
                                        Posted under <a class="color-pri" href=""><?php echo e($cat_name); ?></a> by <?php echo e($usr_name); ?> <?php echo e($usr_name1); ?> - <?php echo e(\Carbon\Carbon::parse($ques->created_at)->isoFormat('MMM Do YYYY')); ?>
    ...
    <div class="pagination-wrapper"><?php echo e($disc->withQueryString()->links()); ?></div>

</section>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('Frontend::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nfz\NFZ\app\Modules/Frontend/Views/page/discussion/index.blade.php ENDPATH**/ ?>