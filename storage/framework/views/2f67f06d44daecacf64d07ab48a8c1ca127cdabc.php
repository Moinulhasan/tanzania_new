    ...
    <div class="layout-top-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-header">
                ...
                <form action="<?php echo e(route('count-edit',$single->id)); ?>" method="post">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-8">
                            ...
                            <select name="menu" id="menuName" class="form-control">
                                ...
                                <?php $__currentLoopData = $listMenus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($menu->id); ?>" <?php echo e($single->menu_id == $menu->id ?'selected':''); ?>> <?php echo e($menu->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div class="mt-3 col-md-8">
                            <label for="count">Enter the Row Count</label>
                            <input type="number" value="<?php echo e($single->title); ?>" id="count" class="form-control" name="count" >
                        </div>
