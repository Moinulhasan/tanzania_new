...
<div class="booking-type d-flex align-items-center">
    <a href="javascript:void(0);" data-type="day" class="<?php if($bookingType == 'day'): ?> active <?php endif; ?>"><?php echo e(__('By Day')); ?></a>
    <a href="javascript:void(0);" data-type="hour" class="<?php if($bookingType == 'hour'): ?> active <?php endif; ?>"><?php echo e(__('By Hour')); ?></a>
</div>
<form id="search-space" method="GET" class="search-form space" action="<?php echo e(url('space-search')); ?>">
    <input type="hidden" name="bookingType" id="booking-type-input" value="<?php echo e($bookingType); ?>" />
        ...
        <div class="search-form__advanced bg-white">
            <div class="container">
                <div class="row">
                    ...
                    <?php if(!empty($space_types)): ?>
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            <div class="search-form__label"><?php echo e(__('Types')); ?></div>
                            <?php $__currentLoopData = $space_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="space_types[]" value="<?php echo e($key); ?>"><span><?php echo e(get_translate($type)); ?></span></label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <input type="hidden" name="space_type" value=""/>
                        </div>
                    <?php endif; ?>

                    <?php if(!empty($space_amenity)): ?>
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            <div class="search-form__label"><?php echo e(__('Amenities')); ?></div>
                            <?php $__currentLoopData = $space_amenity; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="space_amenities[]" value="<?php echo e($key); ?>"><span><?php echo e(get_translate($value)); ?></span></label>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php endif; ?>
</form><?php /**PATH C:\xampp\htdocs\nfz\tanzania\app\Modules/Frontend/Views/services/space/search-form.blade.php ENDPATH**/ ?>